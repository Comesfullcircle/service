    ...
    public List<UserOrderDetailResponse> current(User user) {
        var userOrderEntityList = userOrderService.current(user.getId());
               ...
               var userOrderDetailResponseList = userOrderEntityList.stream().map(it->{
                    ...
                    var storeMenuEnityList = userOrderMenuEntityList.stream()
                    ...
                    var storeEntity = storeService.getStoreWithTrow(storeMenuEnityList.stream().findFirst().get().getStoreId());

                    return UserOrderDetailResponse.builder()
                            .userOrderResponse(userOrderConverter.toResponse(it))
                            .storeMenuResponseList(storeMenuConverter.toResponse(storeMenuEnityList))
